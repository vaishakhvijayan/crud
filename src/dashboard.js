...
import{
    TextField,Dialog,DialogActions,LinearProgress,
...
export default class Dashboard extends Component{
    ...
    onChange = (e) =>{
        if (e.target.files && e.target.files[0] && e.targrt.files[0].name){
                    ...
                    <TableBody>
                        {this.state.products.map((row) => (
                            <TableRow key={row.name}>
                                ...
                                <TableCell align="center">< img src={`http://localhost:2000/${row.image}`} width="70" height="70" alt="" /></TableCell>
